...
module.exports = {
SESSION_ID: process.env.SESSION_ID ==='VAJIRA-MD=bM8BRIpD#vYEU99yG7O27mqb9GYp8OB2WKtsawLlm9RNIdLpxUDQ' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER ==='9234214082163' : process.env.OWNER_NUMBER,   
